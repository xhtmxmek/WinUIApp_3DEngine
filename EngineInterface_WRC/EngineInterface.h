...
#include "UIProxy/ActorProxyProcessor.h"
...
namespace winrt::EngineInterface_WRC::implementation
{
    struct EngineInterface : EngineInterfaceT<EngineInterface>
    {
        ...
        winrt::Windows::Foundation::Collections::IObservableVector<winrt::EngineInterface_WRC::ActorProxy> WorldActorList();        
    private: 
    ...
    private:
        ...
        ActorProxyProcessor actorProcessor_;        
